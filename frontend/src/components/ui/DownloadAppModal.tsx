          ...
          >
            ...
            <div className="bg-surface p-4 rounded-2xl border border-border mb-6 flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-text-primary">Direct Android APK Package</h4>
                  <p className="text-[11px] text-text-muted">Version 1.0.0 (CopyCoach-AI-v1.0.apk)</p>
                </div>
              </div>
