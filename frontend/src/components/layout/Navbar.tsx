              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showDropdown && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 rounded-2xl border border-border bg-surface-elevated dark:bg-[#0a0e18] p-2 shadow-2xl z-50 text-text-primary animate-in fade-in zoom-in-95">
                      <div className="px-3 py-2 border-b border-border dark:border-white/15 mb-1">
                      ...
                      <Link
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-medium hover:bg-surface-muted dark:hover:bg-white/15 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-medium text-danger hover:bg-danger-surface transition-colors mt-1 border-t border-border dark:border-white/15"
                      >
