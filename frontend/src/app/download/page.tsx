      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl w-full mb-12">
          ...
          <button
            ...
            className="group relative flex items-center gap-4 p-5 rounded-2xl bg-surface-elevated border border-border hover:border-cyan-500/60 hover:bg-slate-800/90 transition-all shadow-xl cursor-pointer text-left"
          >
          ...
          <a
            ...
            className="group relative flex items-center gap-4 p-5 rounded-2xl bg-surface-elevated border border-border hover:border-cyan-500/60 hover:bg-slate-800/90 transition-all shadow-xl cursor-pointer text-left"
          >
            <div className="p-3 rounded-xl bg-surface border border-border text-white group-hover:scale-105 transition-transform">
              <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
